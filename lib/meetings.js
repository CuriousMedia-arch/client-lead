...
const TRANSCRIPT_REASONS = {
  ...
  provider_cannot_transcribe:
    "Google Meet can't produce transcripts on a free account — that needs a paid Google Workspace plan. Set up Fathom instead and it will record your calls: see FATHOM-SETUP.md.",
  tenant_switch_off:
